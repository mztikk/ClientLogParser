...
namespace ClientLogParser.Parsers.RegexImplementations
{
    ...
    public class OfficialCurrencyParserRegex : IItemParser
    {
        ...
        {
            _tradeCurrency = new Regex($@"(.*)Hi, I'd like to buy your (.\d*) {RegexConstants.CurrencyRegex} for my {RegexConstants.CurrencyRegex} in {RegexConstants.LeagueNameRegex}\.(.*)", RegexOptions.Compiled);
        }
